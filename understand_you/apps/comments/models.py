...
class Comments(models.Model):
    ...
    comment_like = models.FloatField(default=0, verbose_name=u"评论点赞数")
    comment_reply = models.FloatField(default=0, verbose_name=u"评论回复数")
    ...
    article_id = models.CharField(max_length=20, verbose_name=u"被评论文章/评论id")
